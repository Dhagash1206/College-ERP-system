...
def attendance(request, stud_id):
    ...
    for ass in ass_list:
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'info/student/attendance.html', {'att_list': att_list})
...
def attendance_detail(request, stud_id, course_id):
    ...
    return render(request, 'info/student/att_detail.html', {'att_list': att_list, 'cr': cr})
...
def timetable(request, class_id):
    ...
    return render(request, 'info/student/timetable.html', {'matrix': matrix})
...
def marks_list(request, stud_id):
    ...
    return render(request, 'info/student/marks_list.html', {'sc_list': sc_list})
