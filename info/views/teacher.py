...
def t_clas(request, teacher_id, choice):
    ...
    return render(request, 'info/teacher/classes.html', {'teacher1': teacher1, 'choice': choice})
...
def t_student(request, assign_id):
    ...
    for stud in ass.class_id.student_set.all():
        try:
            ...
            a.save()
        att_list.append(a)
    return render(request, 'info/teacher/students.html', {'att_list': att_list})
...
def t_class_date(request, assign_id):
    ...
    return render(request, 'info/teacher/class_dates.html', {'att_list': att_list})
...
def t_attendance(request, ass_c_id):
    ...
    return render(request, 'info/teacher/attendance.html', context)
...
def edit_att(request, ass_c_id):
    ...
    return render(request, 'info/teacher/edit_attendance.html', context)
...
def t_attendance_detail(request, stud_id, course_id):
    ...
    return render(request, 'info/teacher/attendance_detail.html', {'att_list': att_list, 'cr': cr})
...
def t_extra_class(request, assign_id):
    ...
    return render(request, 'info/teacher/extra_class.html', context)
...
def t_report(request, assign_id):
    ...
    for stud in ass.class_id.student_set.all():
        ...
        sc_list.append(a)
    return render(request, 'info/teacher/report.html', {'sc_list': sc_list})
...
def t_timetable(request, teacher_id):
    ...
    return render(request, 'info/teacher/timetable.html', {'class_matrix': class_matrix})
...
def free_teachers(request, asst_id):
    ...
    return render(request, 'info/teacher/free_teachers.html', {'ft_list': ft_list})
...
def t_marks_list(request, assign_id):
    ...
    return render(request, 'info/teacher/marks_list.html', {'m_list': m_list})
...
def t_marks_entry(request, marks_c_id):
    ...
    return render(request, 'info/teacher/marks_entry.html', context)
...
def edit_marks(request, marks_c_id):
    ...
    return render(request, 'info/teacher/edit_marks.html', context)
...
def student_marks(request, assign_id):
    ...
    return render(request, 'info/teacher/student_marks.html', {'sc_list': sc_list})
